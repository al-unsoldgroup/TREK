...
export default function TripAdvicePlaceRow({ controller, place: source, idea = false, assignmentKey }: { controller: TripAdviceController; place: AdvicePlaceView; idea?: boolean; assignmentKey?: string }) {
