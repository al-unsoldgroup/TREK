...
const oauth: TranslationStrings = {
  ...
  'oauth.scope.group.profile': 'Perfil de viagem',
  ...
  'oauth.scope.profile:read.label': 'Ver perfil de viagem',
  'oauth.scope.profile:read.description': 'Ler preferências de viagem, programas de fidelidade e restrições',
  'oauth.scope.profile:write.label': 'Gerenciar perfil de viagem',
  'oauth.scope.profile:write.description': 'Atualizar preferências de viagem, programas de fidelidade e restrições',
