...
const oauth: TranslationStrings = {
  ...
  'oauth.scope.group.profile': 'Reisprofiel',
  ...
  'oauth.scope.profile:read.label': 'Reisprofiel bekijken',
  'oauth.scope.profile:read.description': "Reisvoorkeuren, loyaliteitsprogramma's en beperkingen lezen",
  'oauth.scope.profile:write.label': 'Reisprofiel beheren',
  'oauth.scope.profile:write.description': "Reisvoorkeuren, loyaliteitsprogramma's en beperkingen bijwerken",
