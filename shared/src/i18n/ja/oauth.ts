...
const oauth: TranslationStrings = {
  ...
  'oauth.scope.group.profile': '旅行プロフィール',
  ...
  'oauth.scope.profile:read.label': '旅行プロフィールを表示',
  'oauth.scope.profile:read.description': '旅行の好み、ロイヤルティプログラム、制約を読み取る',
  'oauth.scope.profile:write.label': '旅行プロフィールを管理',
  'oauth.scope.profile:write.description': '旅行の好み、ロイヤルティプログラム、制約を更新する',
