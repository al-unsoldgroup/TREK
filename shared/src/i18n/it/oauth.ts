...
const oauth: TranslationStrings = {
  ...
  'oauth.scope.group.profile': 'Profilo di viaggio',
  ...
  'oauth.scope.profile:read.label': 'Visualizza profilo di viaggio',
  'oauth.scope.profile:read.description': 'Leggi preferenze di viaggio, programmi fedeltà e vincoli',
  'oauth.scope.profile:write.label': 'Gestisci profilo di viaggio',
  'oauth.scope.profile:write.description': 'Aggiorna preferenze di viaggio, programmi fedeltà e vincoli',
