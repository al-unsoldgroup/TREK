...
const oauth: TranslationStrings = {
  ...
  'oauth.scope.group.profile': '여행 프로필',
  ...
  'oauth.scope.profile:read.label': '여행 프로필 보기',
  'oauth.scope.profile:read.description': '여행 선호도, 로열티 프로그램 및 제약 조건 읽기',
  'oauth.scope.profile:write.label': '여행 프로필 관리',
  'oauth.scope.profile:write.description': '여행 선호도, 로열티 프로그램 및 제약 조건 업데이트',
