...
const settings: TranslationStrings = {
  ...
  'settings.aiParsing.gatewayAccountId': 'Cloudflare 계정 ID',
  'settings.aiParsing.gatewayId': '게이트웨이 ID',
  'settings.aiParsing.gatewayHint': 'TREK가 이 두 ID로 엔드포인트를 만듭니다 — 기본 URL은 필요하지 않습니다.',
  'settings.aiParsing.gatewayApiKeyHint':
    'DeepSeek API 키입니다. 암호화되어 저장됩니다. 현재 키를 유지하려면 비워 두세요.',
  'settings.aiParsing.gatewayToken': '게이트웨이 토큰',
  'settings.aiParsing.gatewayTokenHint': '게이트웨이에 인증이 켜져 있을 때만 필요합니다. 암호화되어 저장됩니다.',
