...
const oauth: TranslationStrings = {
  ...
  'oauth.scope.group.profile': 'Reiseprofil',
  ...
  'oauth.scope.profile:read.label': 'Reiseprofil anzeigen',
  'oauth.scope.profile:read.description': 'Reisepräferenzen, Treueprogramme und Einschränkungen lesen',
  'oauth.scope.profile:write.label': 'Reiseprofil verwalten',
  'oauth.scope.profile:write.description': 'Reisepräferenzen, Treueprogramme und Einschränkungen aktualisieren',
