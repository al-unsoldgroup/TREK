...
const oauth: TranslationStrings = {
  ...
  'oauth.scope.group.profile': 'Travel Profile',
  ...
  'oauth.scope.profile:read.label': 'View travel profile',
  'oauth.scope.profile:read.description': 'Read travel preferences, loyalty programs, and constraints',
  'oauth.scope.profile:write.label': 'Manage travel profile',
  'oauth.scope.profile:write.description': 'Update travel preferences, loyalty programs, and constraints',
