...
const oauth: TranslationStrings = {
  ...
  'oauth.scope.group.profile': 'Профіль мандрівника',
  ...
  'oauth.scope.profile:read.label': 'Перегляд профілю мандрівника',
  'oauth.scope.profile:read.description': 'Читання вподобань у подорожах, програм лояльності та обмежень',
  'oauth.scope.profile:write.label': 'Керування профілем мандрівника',
  'oauth.scope.profile:write.description': 'Оновлення вподобань у подорожах, програм лояльності та обмежень',
