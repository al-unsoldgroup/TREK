...
const oauth: TranslationStrings = {
  ...
  'oauth.scope.group.profile': '旅行檔案',
  ...
  'oauth.scope.profile:read.label': '檢視旅行檔案',
  'oauth.scope.profile:read.description': '讀取旅行偏好、忠誠度計畫和限制',
  'oauth.scope.profile:write.label': '管理旅行檔案',
  'oauth.scope.profile:write.description': '更新旅行偏好、忠誠度計畫和限制',
