...
const oauth: TranslationStrings = {
  ...
  'oauth.scope.group.profile': 'Utazási profil',
  ...
  'oauth.scope.profile:read.label': 'Utazási profil megtekintése',
  'oauth.scope.profile:read.description': 'Utazási preferenciák, hűségprogramok és korlátozások olvasása',
  'oauth.scope.profile:write.label': 'Utazási profil kezelése',
  'oauth.scope.profile:write.description': 'Utazási preferenciák, hűségprogramok és korlátozások frissítése',
