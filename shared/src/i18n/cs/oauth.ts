...
const oauth: TranslationStrings = {
  ...
  'oauth.scope.group.profile': 'Cestovní profil',
  ...
  'oauth.scope.profile:read.label': 'Zobrazit cestovní profil',
  'oauth.scope.profile:read.description': 'Číst cestovní preference, věrnostní programy a omezení',
  'oauth.scope.profile:write.label': 'Spravovat cestovní profil',
  'oauth.scope.profile:write.description': 'Aktualizovat cestovní preference, věrnostní programy a omezení',
