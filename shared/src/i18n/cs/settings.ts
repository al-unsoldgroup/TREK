...
const settings: TranslationStrings = {
  ...
  'settings.aiParsing.gatewayAccountId': 'ID účtu Cloudflare',
  'settings.aiParsing.gatewayId': 'ID brány',
  'settings.aiParsing.gatewayHint': 'TREK sestaví koncový bod z těchto dvou ID — základní URL není potřeba.',
  'settings.aiParsing.gatewayApiKeyHint':
    'Váš API klíč DeepSeek. Ukládá se šifrovaně. Ponechte prázdné pro zachování stávajícího klíče.',
  'settings.aiParsing.gatewayToken': 'Token brány',
  'settings.aiParsing.gatewayTokenHint': 'Potřeba jen tehdy, když má brána zapnuté ověřování. Ukládá se šifrovaně.',
