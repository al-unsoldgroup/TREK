...
const oauth: TranslationStrings = {
  ...
  'oauth.scope.group.profile': 'Hồ sơ du lịch',
  ...
  'oauth.scope.profile:read.label': 'Xem hồ sơ du lịch',
  'oauth.scope.profile:read.description': 'Đọc sở thích du lịch, chương trình khách hàng thân thiết và các hạn chế',
  'oauth.scope.profile:write.label': 'Quản lý hồ sơ du lịch',
  'oauth.scope.profile:write.description': 'Cập nhật sở thích du lịch, chương trình khách hàng thân thiết và các hạn chế',
