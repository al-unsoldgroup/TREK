...
const oauth: TranslationStrings = {
  ...
  'oauth.scope.group.profile': 'Profil Perjalanan',
  ...
  'oauth.scope.profile:read.label': 'Lihat profil perjalanan',
  'oauth.scope.profile:read.description': 'Baca preferensi perjalanan, program loyalitas, dan batasan',
  'oauth.scope.profile:write.label': 'Kelola profil perjalanan',
  'oauth.scope.profile:write.description': 'Perbarui preferensi perjalanan, program loyalitas, dan batasan',
