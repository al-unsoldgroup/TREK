...
const oauth: TranslationStrings = {
  ...
  'oauth.scope.group.profile': '旅行档案',
  ...
  'oauth.scope.profile:read.label': '查看旅行档案',
  'oauth.scope.profile:read.description': '读取旅行偏好、忠诚度计划和限制',
  'oauth.scope.profile:write.label': '管理旅行档案',
  'oauth.scope.profile:write.description': '更新旅行偏好、忠诚度计划和限制',
