...
const settings: TranslationStrings = {
  ...
  'settings.aiParsing.gatewayAccountId': 'Cloudflare 账户 ID',
  'settings.aiParsing.gatewayId': '网关 ID',
  'settings.aiParsing.gatewayHint': 'TREK 会根据这两个 ID 生成接入地址 — 无需填写基础 URL。',
  'settings.aiParsing.gatewayApiKeyHint': '你的 DeepSeek API 密钥。加密存储。留空则保留当前密钥。',
  'settings.aiParsing.gatewayToken': '网关令牌',
  'settings.aiParsing.gatewayTokenHint': '仅在网关启用了身份验证时才需要。加密存储。',
