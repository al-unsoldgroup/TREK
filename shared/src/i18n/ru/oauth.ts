...
const oauth: TranslationStrings = {
  ...
  'oauth.scope.group.profile': 'Профиль путешественника',
  ...
  'oauth.scope.profile:read.label': 'Просмотр профиля путешественника',
  'oauth.scope.profile:read.description': 'Чтение предпочтений в поездках, программ лояльности и ограничений',
  'oauth.scope.profile:write.label': 'Управление профилем путешественника',
  'oauth.scope.profile:write.description': 'Обновление предпочтений в поездках, программ лояльности и ограничений',
