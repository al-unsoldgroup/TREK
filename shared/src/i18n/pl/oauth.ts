...
const oauth: TranslationStrings = {
  ...
  'oauth.scope.group.profile': 'Profil podróży',
  ...
  'oauth.scope.profile:read.label': 'Przeglądaj profil podróży',
  'oauth.scope.profile:read.description': 'Odczytuj preferencje podróżne, programy lojalnościowe i ograniczenia',
  'oauth.scope.profile:write.label': 'Zarządzaj profilem podróży',
  'oauth.scope.profile:write.description': 'Aktualizuj preferencje podróżne, programy lojalnościowe i ograniczenia',
