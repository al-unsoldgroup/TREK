...
const settings: TranslationStrings = {
  ...
  'settings.aiParsing.gatewayAccountId': 'معرّف حساب Cloudflare',
  'settings.aiParsing.gatewayId': 'معرّف البوابة',
  'settings.aiParsing.gatewayHint': 'يبني TREK نقطة الوصول من هذين المعرّفين — لا حاجة إلى عنوان URL أساسي.',
  'settings.aiParsing.gatewayApiKeyHint':
    'مفتاح DeepSeek الخاص بك. يُخزَّن مشفَّرًا. اتركه فارغًا للإبقاء على المفتاح الحالي.',
  'settings.aiParsing.gatewayToken': 'رمز البوابة',
  'settings.aiParsing.gatewayTokenHint': 'مطلوب فقط إذا كانت المصادقة مفعّلة على بوابتك. يُخزَّن مشفَّرًا.',
