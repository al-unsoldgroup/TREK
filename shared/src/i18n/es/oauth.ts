...
const oauth: TranslationStrings = {
  ...
  'oauth.scope.group.profile': 'Perfil de viaje',
  ...
  'oauth.scope.profile:read.label': 'Ver perfil de viaje',
  'oauth.scope.profile:read.description': 'Leer preferencias de viaje, programas de fidelización y restricciones',
  'oauth.scope.profile:write.label': 'Gestionar perfil de viaje',
  'oauth.scope.profile:write.description': 'Actualizar preferencias de viaje, programas de fidelización y restricciones',
