...
const oauth: TranslationStrings = {
  ...
  'oauth.scope.group.profile': 'Ταξιδιωτικό προφίλ',
  ...
  'oauth.scope.profile:read.label': 'Προβολή ταξιδιωτικού προφίλ',
  'oauth.scope.profile:read.description': 'Ανάγνωση ταξιδιωτικών προτιμήσεων, προγραμμάτων επιβράβευσης και περιορισμών',
  'oauth.scope.profile:write.label': 'Διαχείριση ταξιδιωτικού προφίλ',
  'oauth.scope.profile:write.description': 'Ενημέρωση ταξιδιωτικών προτιμήσεων, προγραμμάτων επιβράβευσης και περιορισμών',
