...
export const envSchema = z.object({
  ...
  TREK_PUBLIC_ADVICE_ENABLED: boolStr,
  TREK_PUBLIC_ADVICE_GOOGLE_ENABLED: boolStr,
  TREK_PUBLIC_ADVICE_GOOGLE_TERMS_URL: url,
  TREK_PUBLIC_ADVICE_GOOGLE_PRIVACY_URL: url,
  TREK_PUBLIC_ADVICE_GOOGLE_BUDGET_CENTS: integer(1),
