...
export const SCOPE_INFO: Record<Scope, ScopeInfo> = {
  ...
  'profile:read':        { label: 'View travel profile',        description: 'Read travel preferences, loyalty programs, and constraints',             group: 'Travel Profile' },
  'profile:write':       { label: 'Manage travel profile',      description: 'Update travel preferences, loyalty programs, and constraints',           group: 'Travel Profile' },
